...
export class InboxComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.controls = [
      ...
      {
        controlName: "entidad", controlValue: null, placeholder: "Entidad de origen", validators: [], class: "col-12", type: "select", optionValue: "id", optionLabel: "title", options: this.options
      },
