...
@Component({
  selector: 'app-documents-with-response-time',
  templateUrl: './documents-with-response-time.component.html',
  styleUrls: ['./documents-with-response-time.component.scss']
})
export class DocumentsWithResponseTimeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.table = {
      columns: [
        ...
        {
          columnDef: 'diasPlazo',
          columnFilter: 'diasPlazo',
          header: 'Días de plazo',
          type: 'text',
        },
        {
          columnDef: 'fechaPlazo',
          columnFilter: 'fechaPlazo',
    ...
    this.table.data = [
      { estado: 'En tramitación', diasPlazo: '10', fechaPlazo: '20/09/2020', documento: { title: "SOLICITUD RRHH", data: [{ title: "Realizador: ", content: "ANDREA MARIN" }, { title: "creación: ", content: "20/09/2020" }, { title: "asunto: ", content: "Lorem ipsum dolor sit ament" }] } },
      { estado: 'Completo', diasPlazo: '5', fechaPlazo: '20/09/2020', documento: { title: "SOLICITUD RRHH", data: [{ title: "Realizador: ", content: "ANDREA MARIN" }, { title: "creación: ", content: "20/09/2020" }, { title: "asunto: ", content: "Lorem ipsum dolor sit ament" }] } },
    ]

    this.utils.initView('documentswithresponsetime')
  }
