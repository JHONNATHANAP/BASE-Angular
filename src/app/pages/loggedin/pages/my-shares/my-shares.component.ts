...
export class MySharesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.table.data = [
      { participation: 'Validador', folio: '2020-1345-temp', documento: { title: "SOLICITUD RRHH", data: [{ title: "Realizador: ", content: "ANDREA MARIN" }, { title: "creación: ", content: "20/09/2020" }, { title: "asunto: ", content: "Lorem ipsum dolor sit ament" }] } },
      { participation: 'Aprobador', folio: '2020-1345-temp', documento: { title: "SOLICITUD RRHH", data: [{ title: "Realizador: ", content: "ANDREA MARIN" }, { title: "creación: ", content: "20/09/2020" }, { title: "asunto: ", content: "Lorem ipsum dolor sit ament" }] } },
    ]

    this.utils.initView('myshares')
  }
